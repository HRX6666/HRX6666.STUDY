...
import com.example.playandroid.Tool.POSTConnection;
...
public class  Eroll extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Toast.makeText( Eroll.this, m, Toast.LENGTH_SHORT).show();
                    Log.e("错误信息",m);
                    break;
                case 2:
                    Toast.makeText(Eroll.this, "注册成功", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 3:
                    Toast.makeText(Eroll.this, "请求超时", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_account = findViewById(R.id.edit_enroll_account);
        editText_password = findViewById(R.id.edit_enroll_password);
        editText_repassword = findViewById(R.id.edit_enroll_repassword);
        button_register = findViewById(R.id.bt_enroll);

        user_accont = findViewById(R.id.im_enroll_username);
        pass_clock = findViewById(R.id.enroll_pass_clock);
        repass_clock = findViewById(R.id.enroll_repass_clock);
        bt_back = findViewById(R.id.enroll_back);
        ...
        editText_password.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (mlongth == 0) {
                    ...
                    pass_clock.setImageResource(R.drawable.clock_bule);
                } else {
        ...
        editText_account.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (mlongth == 0) {
                    ...
                    user_accont.setImageResource(R.drawable.have_user);
                } else {
                    user_accont.setImageResource(R.drawable.no_user);
                }
            }
        });
        editText_repassword.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (mlongth == 0) {
                    ...
                    repass_clock.setImageResource(R.drawable.clock_bule);
                } else {
        ...
        button_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(username) || TextUtils.isEmpty(password) || TextUtils.isEmpty(repassword)) {
                    Toast.makeText(Eroll.this, "账号和密码不能为空", Toast.LENGTH_SHORT).show();
                } else if (mlongth < 6) {
                    Toast.makeText(Eroll.this, "密码长度必须大于6", Toast.LENGTH_SHORT).show();
                } else if (mlongth_u < 4) {
                    Toast.makeText(Eroll.this, "账号长度必须大于4", Toast.LENGTH_SHORT).show();
                    ...
                    ProgressDialog progressDialog = new ProgressDialog(Eroll.this);
                    ...
                    Toast.makeText(Eroll.this, "两次输入的密码不同", Toast.LENGTH_SHORT).show();
                }
