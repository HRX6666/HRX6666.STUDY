...
public class SearchResultFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =inflater.inflate(R.layout.fragment_saerch_result2,container,false);
        initView();
    ...
    public void initView() {
        recyclerView = view.findViewById(R.id.search_result_v2);
        recyclerView.addItemDecoration(new SpacesItemDecoration(14));
        textView = view.findViewById(R.id.search_key2);
