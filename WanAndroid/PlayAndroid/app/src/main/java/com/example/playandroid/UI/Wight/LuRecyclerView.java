...
import com.example.playandroid.Tool.ListDataHolder;
...
public class LuRecyclerView extends RecyclerView {
    ...
    public LuRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LuRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void showLoadMore() {
        showFooterStatus(R.layout.item_footer_looding_more);
